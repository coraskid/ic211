...
public class ControlPanel extends JPanel{
  ...
  public ControlPanel(Proj f, Zoo zoo){
    ...
    addFish.addActionListener(new AddActionListener(addFish, addType, zoo, f));
    ...
    onOff.addActionListener(new PauseActionListener(onOff, f));
